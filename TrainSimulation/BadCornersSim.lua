...
oms_addSubModel("TrainSimulation.root.curveCollection", "../TrainSimulation/TrainSimulation.StructureCollection/TrainSimulation.StructureCollection.fmu")
...
oms_addSubModel("TrainSimulation.root.Curve", "../TrainSimulation/TrainSimulation.Curve/TrainSimulation.Curve.fmu")
...
simulationEnd=10.0 
stepsize=0.01 
oms_setResultFile("TrainSimulation", "../TrainSimulation/BadCornersSim.mat")
