...
const char *TrainSimulation_Train_zeroCrossingDescription(int i, int **out_EquationIndexes)
{
  ...
  "speed <= speed * onUpHillSpeedScale and ActiveUpHill",
  "speed >= speed * onUpHillSpeedScale and ActiveUpHill",
  ...
  static const int occurEqs4[] = {1,50};
  ...
  static const int occurEqs13[] = {1,41};
  static const int occurEqs14[] = {1,41};
  static const int occurEqs15[] = {1,41};
  static const int occurEqs16[] = {1,42};
...
int TrainSimulation_Train_function_ZeroCrossings(DATA *data, threadData_t *threadData, double *gout)
{
  ...
  gout[0] = (tmp0) ? 1 : -1;
  tmp1 = LessEqZC(data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, (data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */) * (data->localData[0]->realVars[15] /* onUpHillSpeedScale variable */), data->simulationInfo->storedRelations[1]);
  gout[1] = ((tmp1 && data->localData[0]->booleanVars[15] /* ActiveUpHill variable */)) ? 1 : -1;
  tmp2 = GreaterEqZC(data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, (data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */) * (data->localData[0]->realVars[15] /* onUpHillSpeedScale variable */), data->simulationInfo->storedRelations[2]);
  ...
  tmp5 = GreaterEqZC(data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */, data->simulationInfo->realParameter[2] /* lap PARAM */, data->simulationInfo->storedRelations[5]);
  gout[5] = (tmp5) ? 1 : -1;
  ...
  tmp11 = LessEqZC(data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, data->simulationInfo->realParameter[4] /* maxSpeed PARAM */, data->simulationInfo->storedRelations[11]);
  ...
  tmp12 = GreaterEqZC(data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, data->simulationInfo->realParameter[4] /* maxSpeed PARAM */, data->simulationInfo->storedRelations[12]);
...
const char *TrainSimulation_Train_relationDescription(int i)
{
  ...
  "speed <= speed * onUpHillSpeedScale",
  "speed >= speed * onUpHillSpeedScale",
  "speed <= onCurveSpeed",
  "speed >= onCurveSpeed",
  "lapDistance >= lap",
...
int TrainSimulation_Train_function_updateRelations(DATA *data, threadData_t *threadData, int evalforZeroCross)
{
  ...
  if(evalforZeroCross) {
    ...
    tmp29 = LessEqZC(data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, (data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */) * (data->localData[0]->realVars[15] /* onUpHillSpeedScale variable */), data->simulationInfo->storedRelations[1]);
    data->simulationInfo->relations[1] = tmp29;
    tmp30 = GreaterEqZC(data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, (data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */) * (data->localData[0]->realVars[15] /* onUpHillSpeedScale variable */), data->simulationInfo->storedRelations[2]);
    ...
    tmp33 = GreaterEqZC(data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */, data->simulationInfo->realParameter[2] /* lap PARAM */, data->simulationInfo->storedRelations[5]);
    ...
    tmp39 = LessEqZC(data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, data->simulationInfo->realParameter[4] /* maxSpeed PARAM */, data->simulationInfo->storedRelations[11]);
    data->simulationInfo->relations[11] = tmp39;
    tmp40 = GreaterEqZC(data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, data->simulationInfo->realParameter[4] /* maxSpeed PARAM */, data->simulationInfo->storedRelations[12]);
    ...
    data->simulationInfo->relations[1] = (data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */ <= (data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */) * (data->localData[0]->realVars[15] /* onUpHillSpeedScale variable */));
    data->simulationInfo->relations[2] = (data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */ >= (data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */) * (data->localData[0]->realVars[15] /* onUpHillSpeedScale variable */));
    ...
    data->simulationInfo->relations[5] = (data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */ >= data->simulationInfo->realParameter[2] /* lap PARAM */);
    ...
    data->simulationInfo->relations[11] = (data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */ <= data->simulationInfo->realParameter[4] /* maxSpeed PARAM */);
    data->simulationInfo->relations[12] = (data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */ >= data->simulationInfo->realParameter[4] /* maxSpeed PARAM */);
