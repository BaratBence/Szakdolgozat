...
const char *TrainSimulation_Train_zeroCrossingDescription(int i, int **out_EquationIndexes)
{
  ...
  static const int occurEqs5[] = {1,47};
  static const int occurEqs6[] = {1,33};
  static const int occurEqs7[] = {1,34};
  static const int occurEqs8[] = {1,35};
  static const int occurEqs9[] = {1,36};
  static const int occurEqs10[] = {1,37};
  static const int occurEqs11[] = {1,38};
  static const int occurEqs12[] = {1,39};
  static const int occurEqs13[] = {1,39};
...
int TrainSimulation_Train_function_ZeroCrossings(DATA *data, threadData_t *threadData, double *gout)
{
  ...
  tmp0 = LessEqZC(data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, (data->simulationInfo->realParameter[4] /* maxSpeed PARAM */) * (data->localData[0]->realVars[15] /* onUpHillSpeedScale variable */), data->simulationInfo->storedRelations[0]);
  gout[0] = ((tmp0 && data->localData[0]->booleanVars[14] /* ActiveUpHill variable */)) ? 1 : -1;
  tmp1 = GreaterEqZC(data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, (data->simulationInfo->realParameter[4] /* maxSpeed PARAM */) * (data->localData[0]->realVars[15] /* onUpHillSpeedScale variable */), data->simulationInfo->storedRelations[1]);
  gout[1] = ((tmp1 && data->localData[0]->booleanVars[14] /* ActiveUpHill variable */)) ? 1 : -1;
  tmp2 = GreaterEqZC(data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, data->simulationInfo->realParameter[4] /* maxSpeed PARAM */, data->simulationInfo->storedRelations[2]);
  gout[2] = (tmp2) ? 1 : -1;
  ...
  tmp11 = LessZC(data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, data->simulationInfo->realParameter[4] /* maxSpeed PARAM */, data->simulationInfo->storedRelations[11]);
...
int TrainSimulation_Train_function_updateRelations(DATA *data, threadData_t *threadData, int evalforZeroCross)
{
  ...
  if(evalforZeroCross) {
    tmp23 = LessEqZC(data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, (data->simulationInfo->realParameter[4] /* maxSpeed PARAM */) * (data->localData[0]->realVars[15] /* onUpHillSpeedScale variable */), data->simulationInfo->storedRelations[0]);
    data->simulationInfo->relations[0] = tmp23;
    tmp24 = GreaterEqZC(data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, (data->simulationInfo->realParameter[4] /* maxSpeed PARAM */) * (data->localData[0]->realVars[15] /* onUpHillSpeedScale variable */), data->simulationInfo->storedRelations[1]);
    data->simulationInfo->relations[1] = tmp24;
    tmp25 = GreaterEqZC(data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, data->simulationInfo->realParameter[4] /* maxSpeed PARAM */, data->simulationInfo->storedRelations[2]);
    ...
    tmp28 = GreaterEqZC(data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */, data->simulationInfo->realParameter[2] /* lap PARAM */, data->simulationInfo->storedRelations[5]);
    ...
    tmp34 = LessZC(data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, data->simulationInfo->realParameter[4] /* maxSpeed PARAM */, data->simulationInfo->storedRelations[11]);
    ...
    data->simulationInfo->relations[0] = (data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */ <= (data->simulationInfo->realParameter[4] /* maxSpeed PARAM */) * (data->localData[0]->realVars[15] /* onUpHillSpeedScale variable */));
    data->simulationInfo->relations[1] = (data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */ >= (data->simulationInfo->realParameter[4] /* maxSpeed PARAM */) * (data->localData[0]->realVars[15] /* onUpHillSpeedScale variable */));
    data->simulationInfo->relations[2] = (data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */ >= data->simulationInfo->realParameter[4] /* maxSpeed PARAM */);
