...
void TrainSimulation_Train_eqFunction_27(DATA *data, threadData_t *threadData)
{
  ...
  tmp2 = LessEq(data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */,data->simulationInfo->realParameter[4] /* maxSpeed PARAM */);
...
void TrainSimulation_Train_eqFunction_28(DATA *data, threadData_t *threadData)
{
  ...
  tmp5 = GreaterEq(data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */,data->simulationInfo->realParameter[4] /* maxSpeed PARAM */);
