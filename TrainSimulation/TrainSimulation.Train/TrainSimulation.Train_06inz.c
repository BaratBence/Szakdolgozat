...
#include "TrainSimulation.Train_11mix.h"
...
Crashed = false
*/
void TrainSimulation_Train_eqFunction_1(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,1};
  data->localData[0]->booleanVars[16] /* Crashed DISCRETE */ = 0;
  TRACE_POP
}
...
void TrainSimulation_Train_eqFunction_30(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->booleanVars[11] /* $whenCondition8 DISCRETE */ = (((!data->localData[0]->booleanVars[14] /* ActiveUpHill variable */ && data->simulationInfo->booleanVarsPre[14] /* ActiveUpHill variable */) || (data->localData[0]->booleanVars[14] /* ActiveUpHill variable */ && !data->simulationInfo->booleanVarsPre[14] /* ActiveUpHill variable */)) && (!data->localData[0]->booleanVars[14] /* ActiveUpHill variable */));
  TRACE_POP
}
OMC_DISABLE_OPT
void TrainSimulation_Train_functionInitialEquations_0(DATA *data, threadData_t *threadData)
