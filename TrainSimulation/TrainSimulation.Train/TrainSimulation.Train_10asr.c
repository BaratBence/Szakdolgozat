...
*/
void TrainSimulation_Train_eqFunction_76(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  ...
  if(!tmp4)
  {
    ...
    if(!(tmp0 && tmp1))
    {
      ...
      {
        FILE_INFO info = {"E:/Szakdoga/TrainSimulation.mo",80,5,80,24,0};
...
int TrainSimulation_Train_checkForAsserts(DATA *data, threadData_t *threadData)
{
  ...
  TrainSimulation_Train_eqFunction_76(data, threadData);
