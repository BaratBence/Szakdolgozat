...
oms_addSubModel("TrainSimulation.root.Train", "../TrainSimulation/TrainSimulation.Train/TrainSimulation.Train.fmu")
oms_addSubModel("TrainSimulation.root.Train2", "../TrainSimulation/TrainSimulation.Train/TrainSimulation.Train.fmu")
oms_addSubModel("TrainSimulation.root.HillCollection", "../TrainSimulation/TrainSimulation.StructureCollection/TrainSimulation.StructureCollection.fmu")
...
oms_addSubModel("TrainSimulation.root.UpHill", "../TrainSimulation/TrainSimulation.UpHill/TrainSimulation.Uphill.fmu")
...
simulationEnd=10.0 
stepsize=0.01 
oms_setResultFile("TrainSimulation", "../TrainSimulation/UpHillSim.mat")
