...
oms_addSubModel("TrainSimulation.root.Train1", "../TrainSimulation/TrainSimulation.Train/TrainSimulation.Train.fmu")
oms_addSubModel("TrainSimulation.root.Train2", "../TrainSimulation/TrainSimulation.Train/TrainSimulation.Train.fmu")
...
simulationEnd=97.0
stepsize=0.01 
oms_setResultFile("TrainSimulation", "../TrainSimulation/Intersection.mat")
...
oms_setReal("TrainSimulation.root.Train1.lap", 8000)

oms_setReal("TrainSimulation.root.Train2.length",30)
oms_setReal("TrainSimulation.root.Train2.distanceStart", -2000)
oms_setReal("TrainSimulation.root.Train2.lap", 8000)
...
oms_setReal("TrainSimulation.root.Car2.distanceStart", 200)
oms_setReal("TrainSimulation.root.Car2.isClumsy", 1)
