...
static const MMC_DEFSTRUCTLIT(boxvar_lit_TrainSimulation_Curve_OnTrack,2,0) {(void*) boxptr_TrainSimulation_Curve_OnTrack,0}};
#define boxvar_TrainSimulation_Curve_OnTrack MMC_REFSTRUCTLIT(boxvar_lit_TrainSimulation_Curve_OnTrack)
