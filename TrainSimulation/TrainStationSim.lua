...
oms_addSubModel("TrainSimulation.root.Sensor", "../TrainSimulation/TrainSimulation.Sensor/TrainSimulation.Sensor.fmu")
...
simulationEnd=125.0 
stepsize=0.01 
oms_setResultFile("TrainSimulation", "../TrainSimulation/TrainStationSim.mat")
