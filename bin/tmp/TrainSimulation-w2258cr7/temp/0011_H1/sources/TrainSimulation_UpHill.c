...
void TrainSimulation_UpHill_eqFunction_22(DATA *data, threadData_t *threadData)
{
  ...
  real_array tmp20;
  real_array tmp21;
  usub_alloc_real_array(mul_alloc_real_array_scalar(omc_TrainSimulation_UpHill_SpeedCalculations(threadData, ((modelica_integer) 10), (9.810000000000001) * (sin((data->simulationInfo->realParameter[2] /* angle PARAM */) * (0.0174532925)))), 1.0),&tmp20);
  real_array_create(&tmp21, ((modelica_real*)&((&data->localData[0]->realVars[0] /* HillAcc[1] variable */)[calc_base_index_dims_subs(1, 10, ((modelica_integer) 1))])), 1, 10);
  copy_real_array_data(tmp20, &tmp21);
  TRACE_POP
}
...
void TrainSimulation_UpHill_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{9f83f4b1-bc6f-49df-9085-291ffb0639fa}";
