...
*/
void TrainCrossing_TrainLight_eqFunction_161(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  ...
  if(!tmp4)
  {
    ...
    if(!(tmp0 && tmp1))
    {
      ...
      {
        FILE_INFO info = {"E:/Onlab/TrainCrossing2.2/TrainCrossing.mo",101,5,101,54,0};
...
OMC_DISABLE_OPT
int TrainCrossing_TrainLight_checkForAsserts(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH

  TrainCrossing_TrainLight_eqFunction_161(data, threadData);
