...
void TrainCrossing_Car_eqFunction_21(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[20] /* Length variable */ = data->simulationInfo->realParameter[3] /* length PARAM */;
  TRACE_POP
}
/*
equation index: 22
...
equation index: 26
type: SIMPLE_ASSIGN
$cse1 = TrainCrossing.Car.BreakCheck(10, distance, Target, DistanceVec, LengthVec)
*/
void TrainCrossing_Car_eqFunction_26(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[6] /* $cse1 variable */ = omc_TrainCrossing_Car_BreakCheck(threadData, ((modelica_integer) 10), data->localData[0]->realVars[1] /* distance STATE(1,speed) */, data->localData[0]->realVars[31] /* Target variable */, tmp10, tmp11);
  TRACE_POP
}
/*
equation index: 27
...
void TrainCrossing_Car_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{bfa02097-4634-43b6-b07d-743b3b8f59d8}";
