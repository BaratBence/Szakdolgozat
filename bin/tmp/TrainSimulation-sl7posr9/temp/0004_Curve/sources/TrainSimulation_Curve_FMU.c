...
#define MODEL_IDENTIFIER TrainSimulation_Curve
#define MODEL_GUID "{8617e45e-ce71-4ce7-a06d-74fa194473f7}"
...
#define NUMBER_OF_EVENT_INDICATORS 10
#define NUMBER_OF_REALS 68
...
extern void TrainSimulation_Curve_setupDataStruc(DATA *data, threadData_t *threadData);
#define fmu2_model_interface_setupDataStruc TrainSimulation_Curve_setupDataStruc
...
void setDefaultStartValues(ModelInstance *comp) {
  ...
  comp->fmuData->modelData->realParameterData[1].attribute.start = 9.810000000000001;
  comp->fmuData->modelData->realParameterData[2].attribute.start = 40.0;
  comp->fmuData->modelData->realParameterData[3].attribute.start = 1475.0;
  comp->fmuData->modelData->realParameterData[4].attribute.start = 160.0;
  comp->fmuData->modelData->realParameterData[5].attribute.start = 100.0;
  comp->fmuData->modelData->realParameterData[6].attribute.start = 1800.0;
...
static const int realAliasIndexes[20] = {
...
fmi2Real getReal(ModelInstance* comp, const fmi2ValueReference vr) {
  ...
  if (vr < 48) {
    return comp->fmuData->simulationInfo->realParameter[vr-41];
  }
  if (vr < 68) {
    int ix = realAliasIndexes[vr-48];
...
fmi2Status setReal(ModelInstance* comp, const fmi2ValueReference vr, const fmi2Real value) {
  ...
  if (vr < 48) {
    comp->fmuData->simulationInfo->realParameter[vr-41] = value;
    return fmi2OK;
  }
  if (vr < 68) {
    int ix = realAliasIndexes[vr-48];
...
fmi2ValueReference mapInputReference2InputNumber(const fmi2ValueReference vr) {
    switch (vr) {
      ...
      case 26: return 15; break;
      case 27: return 16; break;
      case 28: return 17; break;
      case 29: return 18; break;
      case 30: return 19; break;
      default:
        return -1;
    }
}
...
fmi2ValueReference mapOutputReference2OutputNumber(const fmi2ValueReference vr) {
    switch (vr) {
      ...
      case 33: return 12; break;
      case 34: return 13; break;
      case 35: return 14; break;
      case 36: return 15; break;
      case 37: return 16; break;
      case 38: return 17; break;
      case 39: return 18; break;
      case 40: return 19; break;
      default:
        return -1;
    }
}
