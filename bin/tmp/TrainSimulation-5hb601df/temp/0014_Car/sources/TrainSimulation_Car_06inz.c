...
equation index: 5
type: SIMPLE_ASSIGN
BreakingDistance = 0.5 * (speed / breakingDeceleration) ^ 2.0 * breakingDeceleration + TrainSimulation.Car.BreakCheck(10, distance, Target, DistanceVec, LengthVec)
*/
void TrainSimulation_Car_eqFunction_5(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  ...
  data->localData[0]->realVars[7] /* BreakingDistance variable */ = (0.5) * (((tmp0 * tmp0)) * (data->simulationInfo->realParameter[1] /* breakingDeceleration PARAM */)) + omc_TrainSimulation_Car_BreakCheck(threadData, ((modelica_integer) 10), data->localData[0]->realVars[1] /* distance STATE(1,speed) */, data->localData[0]->realVars[31] /* Target variable */, tmp1, tmp2);
  TRACE_POP
}
...
void TrainSimulation_Car_functionInitialEquations_0(DATA *data, threadData_t *threadData)
{
  ...
  TrainSimulation_Car_eqFunction_5(data, threadData);
