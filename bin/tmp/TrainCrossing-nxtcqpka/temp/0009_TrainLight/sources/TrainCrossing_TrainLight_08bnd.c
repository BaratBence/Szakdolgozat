...
int TrainCrossing_TrainLight_updateBoundParameters(DATA *data, threadData_t *threadData)
{
  ...
  data->simulationInfo->booleanParameter[0] /* OffToOn.enableTimer PARAM */ = 0;
  data->modelData->booleanParameterData[0].time_unvarying = 1;
  data->simulationInfo->booleanParameter[1] /* OnToOff.enableTimer PARAM */ = 0;
  data->modelData->booleanParameterData[1].time_unvarying = 1;
  data->simulationInfo->booleanParameter[2] /* OnToRed.enableTimer PARAM */ = 0;
  data->modelData->booleanParameterData[2].time_unvarying = 1;
  data->simulationInfo->booleanParameter[3] /* RedToOff.enableTimer PARAM */ = 0;
  data->modelData->booleanParameterData[3].time_unvarying = 1;
  data->simulationInfo->booleanParameter[4] /* RedToOn.enableTimer PARAM */ = 0;
