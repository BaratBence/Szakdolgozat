...
int TrainCrossing_Train_output_function(DATA *data, threadData_t *threadData)
{
  ...
  data->simulationInfo->outputVars[0] = data->localData[0]->realVars[2] /* Distance variable */;
  data->simulationInfo->outputVars[1] = data->localData[0]->realVars[3] /* Length variable */;
...
*/
void TrainCrossing_Train_eqFunction_5(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
Distance = distance
*/
void TrainCrossing_Train_eqFunction_6(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,6};
  data->localData[0]->realVars[2] /* Distance variable */ = data->localData[0]->realVars[0] /* distance STATE(1,maxSpeed) */;
  TRACE_POP
}
/*
equation index: 7
...
Length = length
*/
void TrainCrossing_Train_eqFunction_7(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,7};
  data->localData[0]->realVars[3] /* Length variable */ = data->simulationInfo->realParameter[1] /* length PARAM */;
  TRACE_POP
}
...
int TrainCrossing_Train_functionDAE(DATA *data, threadData_t *threadData)
{
  ...
  TrainCrossing_Train_eqFunction_5(data, threadData);
...
/* forwarded equations */
extern void TrainCrossing_Train_eqFunction_5(DATA* data, threadData_t *threadData);
...
void TrainCrossing_Train_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{5f49ff49-285c-41be-8c88-7b7e159328b4}";
