...
*/
OMC_DISABLE_OPT
static void TrainCrossing_Car_eqFunction_31(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
*/
OMC_DISABLE_OPT
static void TrainCrossing_Car_eqFunction_32(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
