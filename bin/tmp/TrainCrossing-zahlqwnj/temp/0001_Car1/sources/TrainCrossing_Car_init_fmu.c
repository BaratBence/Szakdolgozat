...
void TrainCrossing_Car_read_input_fmu(MODEL_DATA* modelData, SIMULATION_INFO* simulationInfo)
{
  ...
  modelData->realParameterData[2].info.name = "length";
  ...
  modelData->realParameterData[2].attribute.start = 4.74;
  ...
  modelData->realParameterData[3].info.info.lineStart = 14;
  modelData->realParameterData[3].info.info.colStart = 5;
  modelData->realParameterData[3].info.info.lineEnd = 14;
  ...
  modelData->realParameterData[4].info.info.lineStart = 13;
  modelData->realParameterData[4].info.info.colStart = 5;
  modelData->realParameterData[4].info.info.lineEnd = 13;
  ...
  modelData->integerVarsData[0].info.id = 1023;
  ...
  modelData->integerVarsData[1].info.id = 1024;
  ...
  modelData->integerParameterData[0].info.info.lineStart = 17;
  modelData->integerParameterData[0].info.info.colStart = 5;
  modelData->integerParameterData[0].info.info.lineEnd = 17;
  ...
  modelData->booleanParameterData[0].info.id = 1030;
  ...
  modelData->booleanParameterData[0].info.info.lineStart = 18;
  modelData->booleanParameterData[0].info.info.colStart = 5;
  modelData->booleanParameterData[0].info.info.lineEnd = 18;
