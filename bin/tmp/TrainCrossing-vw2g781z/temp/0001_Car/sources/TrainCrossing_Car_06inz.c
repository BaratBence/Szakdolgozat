...
void TrainCrossing_Car_eqFunction_5(DATA *data, threadData_t *threadData)
{
  ...
  real_array_create(&tmp1, ((modelica_real*)&((&data->localData[0]->realVars[8] /* DistanceVec[1] variable */)[calc_base_index_dims_subs(1, 3, ((modelica_integer) 1))])), 1, 3);
  real_array_create(&tmp2, ((modelica_real*)&((&data->localData[0]->realVars[12] /* LengthVec[1] variable */)[calc_base_index_dims_subs(1, 3, ((modelica_integer) 1))])), 1, 3);
  data->localData[0]->realVars[7] /* BreakingDistance variable */ = (0.5) * (((tmp0 * tmp0)) * (data->simulationInfo->realParameter[1] /* breakingDeceleration PARAM */)) + omc_TrainCrossing_Car_BreakCheck(threadData, ((modelica_integer) 3), data->localData[0]->realVars[1] /* distance STATE(1,speed) */, data->localData[0]->realVars[15] /* Target variable */, tmp1, tmp2);
  TRACE_POP
}
...
*/
void TrainCrossing_Car_eqFunction_11(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
void TrainCrossing_Car_functionInitialEquations_0(DATA *data, threadData_t *threadData)
{
  ...
  TrainCrossing_Car_eqFunction_11(data, threadData);
