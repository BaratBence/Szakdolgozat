...
*/
OMC_DISABLE_OPT
static void TrainCrossing_TrainLight_eqFunction_157(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
*/
OMC_DISABLE_OPT
static void TrainCrossing_TrainLight_eqFunction_158(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
*/
OMC_DISABLE_OPT
static void TrainCrossing_TrainLight_eqFunction_159(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
*/
OMC_DISABLE_OPT
static void TrainCrossing_TrainLight_eqFunction_160(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
void TrainCrossing_TrainLight_updateBoundParameters_0(DATA *data, threadData_t *threadData)
{
  ...
  TrainCrossing_TrainLight_eqFunction_157(data, threadData);
  TrainCrossing_TrainLight_eqFunction_158(data, threadData);
  TrainCrossing_TrainLight_eqFunction_159(data, threadData);
  TrainCrossing_TrainLight_eqFunction_160(data, threadData);
  TRACE_POP
}
OMC_DISABLE_OPT
