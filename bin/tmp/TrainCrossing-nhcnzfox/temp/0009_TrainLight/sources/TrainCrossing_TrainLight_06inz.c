...
*/
void TrainCrossing_TrainLight_eqFunction_35(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
On.active = true
*/
void TrainCrossing_TrainLight_eqFunction_36(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
*/
void TrainCrossing_TrainLight_eqFunction_53(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
*/
void TrainCrossing_TrainLight_eqFunction_57(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
*/
void TrainCrossing_TrainLight_eqFunction_60(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
*/
void TrainCrossing_TrainLight_eqFunction_63(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
void TrainCrossing_TrainLight_functionInitialEquations_0(DATA *data, threadData_t *threadData)
{
  ...
  TrainCrossing_TrainLight_eqFunction_35(data, threadData);
  TrainCrossing_TrainLight_eqFunction_36(data, threadData);
  ...
  TrainCrossing_TrainLight_eqFunction_53(data, threadData);
