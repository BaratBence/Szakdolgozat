...
const char *TrainSimulation_Train_zeroCrossingDescription(int i, int **out_EquationIndexes)
{
  ...
  static const int occurEqs5[] = {1,34};
...
int TrainSimulation_Train_function_ZeroCrossings(DATA *data, threadData_t *threadData, double *gout)
{
  ...
  gout[6] = ((((data->localData[0]->booleanVars[17] /* inStation DISCRETE */ && tmp7) && tmp8) && tmp9)) ? 1 : -1;
  ...
  gout[7] = ((((tmp10 && (!data->localData[0]->booleanVars[13] /* ActiveCurve variable */)) && (!data->localData[0]->booleanVars[14] /* ActiveUpHill variable */)) && (!data->localData[0]->booleanVars[17] /* inStation DISCRETE */))) ? 1 : -1;
  ...
  gout[8] = ((tmp11 && (!data->localData[0]->booleanVars[17] /* inStation DISCRETE */))) ? 1 : -1;
  ...
  gout[15] = (((((data->localData[0]->booleanVars[17] /* inStation DISCRETE */ && tmp23) && tmp24) && tmp25) && (data->localData[0]->integerVars[2] /* state DISCRETE */ == 1))) ? 1 : -1;
