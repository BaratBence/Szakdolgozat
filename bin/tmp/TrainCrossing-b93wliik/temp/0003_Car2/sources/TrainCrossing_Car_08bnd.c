...
*/
OMC_DISABLE_OPT
static void TrainCrossing_Car_eqFunction_33(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
*/
OMC_DISABLE_OPT
static void TrainCrossing_Car_eqFunction_34(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
void TrainCrossing_Car_updateBoundParameters_0(DATA *data, threadData_t *threadData);
extern void TrainCrossing_Car_eqFunction_6(DATA *data, threadData_t *threadData);

extern void TrainCrossing_Car_eqFunction_5(DATA *data, threadData_t *threadData);

extern void TrainCrossing_Car_eqFunction_4(DATA *data, threadData_t *threadData);

extern void TrainCrossing_Car_eqFunction_3(DATA *data, threadData_t *threadData);

extern void TrainCrossing_Car_eqFunction_2(DATA *data, threadData_t *threadData);

extern void TrainCrossing_Car_eqFunction_1(DATA *data, threadData_t *threadData);
...
int TrainCrossing_Car_updateBoundParameters(DATA *data, threadData_t *threadData)
{
  ...
  TrainCrossing_Car_updateBoundParameters_0(data, threadData);
  TRACE_POP
  return 0;
}
