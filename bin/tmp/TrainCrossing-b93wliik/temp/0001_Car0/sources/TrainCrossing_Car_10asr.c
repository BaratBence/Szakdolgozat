...
*/
void TrainCrossing_Car_eqFunction_43(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  ...
  if(!tmp4)
  {
    ...
    if(!(tmp0 && tmp1))
    {
      ...
      {
        FILE_INFO info = {"E:/Onlab/TrainCrossing2.0/TrainCrossing.mo",9,5,9,54,0};
...
int TrainCrossing_Car_checkForAsserts(DATA *data, threadData_t *threadData)
{
  ...
  TrainCrossing_Car_eqFunction_43(data, threadData);
