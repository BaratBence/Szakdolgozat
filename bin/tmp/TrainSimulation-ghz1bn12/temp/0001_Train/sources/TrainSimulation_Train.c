...
void TrainSimulation_Train_eqFunction_34(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp1, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */ + data->localData[0]->realVars[8] /* BreakingDistance variable */ + 10.0, data->localData[0]->realVars[11] /* Sensor1Position variable */, 5, GreaterEq);
  RELATIONHYSTERESIS(tmp2, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */, data->localData[0]->realVars[12] /* Sensor2Position variable */, 6, LessEq);
  data->localData[0]->booleanVars[17] /* inStation DISCRETE */ = (tmp1 && tmp2);
  TRACE_POP
}
/*
equation index: 35
...
void TrainSimulation_Train_eqFunction_35(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp3, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */, data->localData[0]->realVars[11] /* Sensor1Position variable */, 7, Greater);
  RELATIONHYSTERESIS(tmp4, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */, data->localData[0]->realVars[12] /* Sensor2Position variable */, 8, Less);
  RELATIONHYSTERESIS(tmp5, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */ + 11.0, data->localData[0]->realVars[13] /* Station variable */, 9, GreaterEq);
  data->localData[0]->booleanVars[15] /* Arrived DISCRETE */ = (((data->localData[0]->booleanVars[17] /* inStation DISCRETE */ && tmp3) && tmp4) && tmp5);
  TRACE_POP
}
/*
equation index: 36
...
void TrainSimulation_Train_eqFunction_36(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp6, data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, data->simulationInfo->realParameter[5] /* maxSpeed PARAM */, 10, LessEq);
  data->localData[0]->booleanVars[7] /* $whenCondition4 DISCRETE */ = (((tmp6 && (!data->localData[0]->booleanVars[13] /* ActiveCurve variable */)) && (!data->localData[0]->booleanVars[14] /* ActiveUpHill variable */)) && (!data->localData[0]->booleanVars[17] /* inStation DISCRETE */));
  TRACE_POP
}
/*
equation index: 37
...
void TrainSimulation_Train_eqFunction_37(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp7, data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, data->simulationInfo->realParameter[5] /* maxSpeed PARAM */, 11, GreaterEq);
  data->localData[0]->booleanVars[8] /* $whenCondition5 DISCRETE */ = (tmp7 && (!data->localData[0]->booleanVars[17] /* inStation DISCRETE */));
  TRACE_POP
}
/*
equation index: 38
type: SIMPLE_ASSIGN
$whenCondition12 = inStation and speed <= 0.0 and Arrived
*/
void TrainSimulation_Train_eqFunction_38(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp8, data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, 0.0, 12, LessEq);
  data->localData[0]->booleanVars[3] /* $whenCondition12 DISCRETE */ = ((data->localData[0]->booleanVars[17] /* inStation DISCRETE */ && tmp8) && data->localData[0]->booleanVars[15] /* Arrived DISCRETE */);
  TRACE_POP
}
/*
equation index: 39
type: SIMPLE_ASSIGN
$whenCondition11 = inStation and speed > 0.0 and lapDistance + BreakingDistance + 10.0 >= Station and lapDistance + BreakingDistance - 10.0 <= Station and not Arrived
*/
void TrainSimulation_Train_eqFunction_39(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp9, data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, 0.0, 13, Greater);
  RELATIONHYSTERESIS(tmp10, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */ + data->localData[0]->realVars[8] /* BreakingDistance variable */ + 10.0, data->localData[0]->realVars[13] /* Station variable */, 14, GreaterEq);
  RELATIONHYSTERESIS(tmp11, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */ + data->localData[0]->realVars[8] /* BreakingDistance variable */ - 10.0, data->localData[0]->realVars[13] /* Station variable */, 15, LessEq);
  data->localData[0]->booleanVars[2] /* $whenCondition11 DISCRETE */ = ((((data->localData[0]->booleanVars[17] /* inStation DISCRETE */ && tmp9) && tmp10) && tmp11) && (!data->localData[0]->booleanVars[15] /* Arrived DISCRETE */));
  TRACE_POP
}
/*
equation index: 40
type: SIMPLE_ASSIGN
$whenCondition8 = inStation and speed > 0.0 and lapDistance + BreakingDistance + 5.0 >= Sensor1Position - 10.0 and lapDistance + BreakingDistance - 5.0 <= Sensor1Position - 10.0 and state == TrainSimulation.StationSignal.red
*/
void TrainSimulation_Train_eqFunction_40(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp12, data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, 0.0, 13, Greater);
  RELATIONHYSTERESIS(tmp13, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */ + data->localData[0]->realVars[8] /* BreakingDistance variable */ + 5.0, data->localData[0]->realVars[11] /* Sensor1Position variable */ - 10.0, 16, GreaterEq);
  RELATIONHYSTERESIS(tmp14, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */ + data->localData[0]->realVars[8] /* BreakingDistance variable */ - 5.0, data->localData[0]->realVars[11] /* Sensor1Position variable */ - 10.0, 17, LessEq);
  data->localData[0]->booleanVars[11] /* $whenCondition8 DISCRETE */ = ((((data->localData[0]->booleanVars[17] /* inStation DISCRETE */ && tmp12) && tmp13) && tmp14) && (data->localData[0]->integerVars[2] /* state DISCRETE */ == 2));
  TRACE_POP
}
/*
equation index: 41
...
void TrainSimulation_Train_eqFunction_41(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp16, data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, 0.0, 12, LessEq);
  RELATIONHYSTERESIS(tmp17, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */ + data->localData[0]->realVars[8] /* BreakingDistance variable */ + 5.0, data->localData[0]->realVars[11] /* Sensor1Position variable */ - 10.0, 16, GreaterEq);
  RELATIONHYSTERESIS(tmp18, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */ + data->localData[0]->realVars[8] /* BreakingDistance variable */ - 5.0, data->localData[0]->realVars[11] /* Sensor1Position variable */ - 10.0, 17, LessEq);
  data->localData[0]->booleanVars[12] /* $whenCondition9 DISCRETE */ = ((((data->localData[0]->booleanVars[17] /* inStation DISCRETE */ && tmp16) && tmp17) && tmp18) && (data->localData[0]->integerVars[2] /* state DISCRETE */ == 2));
  TRACE_POP
}
/*
equation index: 42
type: SIMPLE_ASSIGN
$whenCondition10 = inStation and speed < 45.0 and lapDistance + BreakingDistance + 5.0 >= Sensor1Position - 10.0 and lapDistance + BreakingDistance - 5.0 <= Sensor1Position - 10.0 and state == TrainSimulation.StationSignal.green
*/
void TrainSimulation_Train_eqFunction_42(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp20, data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, 45.0, 18, Less);
  RELATIONHYSTERESIS(tmp21, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */ + data->localData[0]->realVars[8] /* BreakingDistance variable */ + 5.0, data->localData[0]->realVars[11] /* Sensor1Position variable */ - 10.0, 16, GreaterEq);
  RELATIONHYSTERESIS(tmp22, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */ + data->localData[0]->realVars[8] /* BreakingDistance variable */ - 5.0, data->localData[0]->realVars[11] /* Sensor1Position variable */ - 10.0, 17, LessEq);
  data->localData[0]->booleanVars[1] /* $whenCondition10 DISCRETE */ = ((((data->localData[0]->booleanVars[17] /* inStation DISCRETE */ && tmp20) && tmp21) && tmp22) && (data->localData[0]->integerVars[2] /* state DISCRETE */ == 1));
  TRACE_POP
}
/*
equation index: 43
...
void TrainSimulation_Train_eqFunction_48(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp24, data->localData[0]->realVars[0] /* acceleration STATE(1) */, 0.0, 4, Less);
  data->localData[0]->booleanVars[16] /* Decelerating DISCRETE */ = tmp24;
  TRACE_POP
}
/*
equation index: 49
...
void TrainSimulation_Train_eqFunction_50(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp25, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */, data->simulationInfo->realParameter[3] /* lap PARAM */, 3, GreaterEq);
...
void TrainSimulation_Train_eqFunction_51(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp26, data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, data->localData[0]->realVars[14] /* onCurveSpeed variable */, 2, GreaterEq);
  data->localData[0]->booleanVars[5] /* $whenCondition2 DISCRETE */ = (tmp26 && data->localData[0]->booleanVars[13] /* ActiveCurve variable */);
  TRACE_POP
}
/*
equation index: 52
...
void TrainSimulation_Train_eqFunction_52(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp27, data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, data->localData[0]->realVars[14] /* onCurveSpeed variable */, 1, LessEq);
  data->localData[0]->booleanVars[6] /* $whenCondition3 DISCRETE */ = (tmp27 && data->localData[0]->booleanVars[13] /* ActiveCurve variable */);
  TRACE_POP
}
/*
equation index: 53
...
void TrainSimulation_Train_eqFunction_55(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp28, data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, 45.0, 0, GreaterEq);
  data->localData[0]->booleanVars[4] /* $whenCondition13 DISCRETE */ = tmp28;
  TRACE_POP
}
/*
equation index: 68
...
when {$whenCondition10} then
  reinit(acceleration,  breakingDeceleration + 10.0);
end when;
*/
void TrainSimulation_Train_eqFunction_59(DATA *data, threadData_t *threadData)
{
  ...
  {
    data->localData[0]->realVars[0] /* acceleration STATE(1) */ = data->simulationInfo->realParameter[1] /* breakingDeceleration PARAM */ + 10.0;
    infoStreamPrint(LOG_EVENTS, 0, "reinit acceleration = %g", data->localData[0]->realVars[0] /* acceleration STATE(1) */);
    data->simulationInfo->needToIterate = 1;
  }
  TRACE_POP
...
void TrainSimulation_Train_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{dfcfc4b3-7a8b-420a-89d0-c904e28c2467}";
