...
void TrainCrossing_Car_eqFunction_24(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp8, data->localData[0]->realVars[2] /* speed STATE(1,acceleration) */, data->simulationInfo->realParameter[5] /* maxSpeed PARAM */, 1, GreaterEq);
...
void TrainCrossing_Car_eqFunction_26(DATA *data, threadData_t *threadData)
{
  ...
  real_array tmp10;
  real_array tmp11;
  real_array_create(&tmp10, ((modelica_real*)&((&data->localData[0]->realVars[9] /* DistanceVec[1] variable */)[calc_base_index_dims_subs(1, 3, ((modelica_integer) 1))])), 1, 3);
  real_array_create(&tmp11, ((modelica_real*)&((&data->localData[0]->realVars[14] /* LengthVec[1] variable */)[calc_base_index_dims_subs(1, 3, ((modelica_integer) 1))])), 1, 3);
  data->localData[0]->realVars[6] /* $cse1 variable */ = omc_TrainCrossing_Car_BreakCheck(threadData, ((modelica_integer) 3), data->localData[0]->realVars[1] /* distance STATE(1,speed) */, data->localData[0]->realVars[17] /* Target variable */, tmp10, tmp11);
  TRACE_POP
}
/*
equation index: 27
...
void TrainCrossing_Car_eqFunction_27(DATA *data, threadData_t *threadData)
{
  ...
  modelica_real tmp12;
  tmp12 = DIVISION_SIM(data->localData[0]->realVars[2] /* speed STATE(1,acceleration) */,data->simulationInfo->realParameter[0] /* breakingDeceleration PARAM */,"breakingDeceleration",equationIndexes);
  data->localData[0]->realVars[7] /* BreakingDistance variable */ = (0.5) * (((tmp12 * tmp12)) * (data->simulationInfo->realParameter[0] /* breakingDeceleration PARAM */)) + data->localData[0]->realVars[6] /* $cse1 variable */;
  TRACE_POP
}
/*
equation index: 28
...
void TrainCrossing_Car_eqFunction_28(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp13, data->localData[0]->realVars[1] /* distance STATE(1,speed) */ + data->localData[0]->realVars[7] /* BreakingDistance variable */ + 5.0, data->localData[0]->realVars[17] /* Target variable */, 5, GreaterEq);
  RELATIONHYSTERESIS(tmp14, data->localData[0]->realVars[1] /* distance STATE(1,speed) */ + data->localData[0]->realVars[7] /* BreakingDistance variable */ - 5.0, data->localData[0]->realVars[17] /* Target variable */, 6, LessEq);
...
void TrainCrossing_Car_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{1bd7b20b-4ada-4cdb-941b-39a4ec260400}";
  ...
  data->modelData->modelDataXml.nEquations = 38;
