...
*/
void TrainSimulation_Car_eqFunction_36(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  ...
  if(!tmp4)
  {
    ...
    if(!(tmp0 && tmp1))
    {
      ...
      {
        FILE_INFO info = {"E:/Szakdoga/TrainSimulation.mo",489,5,489,54,0};
...
int TrainSimulation_Car_checkForAsserts(DATA *data, threadData_t *threadData)
{
  ...
  TrainSimulation_Car_eqFunction_36(data, threadData);
