...
void TrainSimulation_TrainLight_function_initSample(DATA *data, threadData_t *threadData)
{
  long i=0;
}

const char *TrainSimulation_TrainLight_zeroCrossingDescription(int i, int **out_EquationIndexes)
{
...
int TrainSimulation_TrainLight_function_ZeroCrossingsEquations(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
...
int TrainSimulation_TrainLight_function_ZeroCrossings(DATA *data, threadData_t *threadData, double *gout)
{
  TRACE_PUSH
...
const char *TrainSimulation_TrainLight_relationDescription(int i)
{
...
int TrainSimulation_TrainLight_function_updateRelations(DATA *data, threadData_t *threadData, int evalforZeroCross)
{
  TRACE_PUSH
