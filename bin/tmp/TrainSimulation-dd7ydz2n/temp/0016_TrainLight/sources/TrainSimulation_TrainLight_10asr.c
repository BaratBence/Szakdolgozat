...
*/
void TrainSimulation_TrainLight_eqFunction_168(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  ...
  if(!tmp4)
  {
    ...
    if(!(tmp0 && tmp1))
    {
      ...
      {
        FILE_INFO info = {"E:/Szakdoga/TrainSimulation.mo",423,5,423,54,0};
...
OMC_DISABLE_OPT
int TrainSimulation_TrainLight_checkForAsserts(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH

  TrainSimulation_TrainLight_eqFunction_168(data, threadData);
