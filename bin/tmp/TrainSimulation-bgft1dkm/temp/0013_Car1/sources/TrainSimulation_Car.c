...
int TrainSimulation_Car_input_function(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[7] /* Gate_Angle variable */ = data->simulationInfo->inputVars[0];
  data->localData[0]->realVars[8] /* Target variable */ = data->simulationInfo->inputVars[1];
...
void TrainSimulation_Car_eqFunction_14(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp0, data->localData[0]->realVars[2] /* speed STATE(1,acceleration) */, data->simulationInfo->realParameter[5] /* maxSpeed PARAM */, 9, GreaterEq);
  data->localData[0]->booleanVars[4] /* $whenCondition5 DISCRETE */ = tmp0;
  TRACE_POP
}
/*
equation index: 15
type: SIMPLE_ASSIGN
$whenCondition2 = speed <= 0.0
*/
void TrainSimulation_Car_eqFunction_15(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,15};
  modelica_boolean tmp1;
  RELATIONHYSTERESIS(tmp1, data->localData[0]->realVars[2] /* speed STATE(1,acceleration) */, 0.0, 3, LessEq);
...
equation index: 16
type: SIMPLE_ASSIGN
$whenCondition1 = isClumsy >= 1.0 and Distance - length <= Target and Distance >= Target and speed > 0.0
*/
void TrainSimulation_Car_eqFunction_16(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp3, data->localData[0]->realVars[0] /* Distance STATE(1,speed) */ - data->simulationInfo->realParameter[3] /* length PARAM */, data->localData[0]->realVars[8] /* Target variable */, 0, LessEq);
  RELATIONHYSTERESIS(tmp4, data->localData[0]->realVars[0] /* Distance STATE(1,speed) */, data->localData[0]->realVars[8] /* Target variable */, 1, GreaterEq);
  RELATIONHYSTERESIS(tmp5, data->localData[0]->realVars[2] /* speed STATE(1,acceleration) */, 0.0, 2, Greater);
  data->localData[0]->booleanVars[0] /* $whenCondition1 DISCRETE */ = (((tmp2 && tmp3) && tmp4) && tmp5);
  TRACE_POP
}
/*
equation index: 17
...
void TrainSimulation_Car_eqFunction_17(DATA *data, threadData_t *threadData)
{
  ...
  modelica_real tmp6;
  tmp6 = DIVISION_SIM(data->localData[0]->realVars[2] /* speed STATE(1,acceleration) */,data->simulationInfo->realParameter[0] /* breakingDeceleration PARAM */,"breakingDeceleration",equationIndexes);
  data->localData[0]->realVars[6] /* BreakingDistance variable */ = (0.5) * (((tmp6 * tmp6)) * (data->simulationInfo->realParameter[0] /* breakingDeceleration PARAM */));
  TRACE_POP
}
/*
equation index: 18
...
void TrainSimulation_Car_eqFunction_18(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[5] /* der(speed) STATE_DER */ = data->localData[0]->realVars[1] /* acceleration STATE(1) */;
  TRACE_POP
}
/*
equation index: 19
...
void TrainSimulation_Car_eqFunction_19(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[3] /* der(Distance) STATE_DER */ = data->localData[0]->realVars[2] /* speed STATE(1,acceleration) */;
  TRACE_POP
}
/*
equation index: 20
...
void TrainSimulation_Car_eqFunction_22(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp7, data->localData[0]->realVars[0] /* Distance STATE(1,speed) */, data->localData[0]->realVars[8] /* Target variable */, 4, Less);
  RELATIONHYSTERESIS(tmp9, data->localData[0]->realVars[7] /* Gate_Angle variable */, 90.0, 5, GreaterEq);
  RELATIONHYSTERESIS(tmp10, data->localData[0]->realVars[2] /* speed STATE(1,acceleration) */, data->simulationInfo->realParameter[5] /* maxSpeed PARAM */, 6, Less);
  data->localData[0]->booleanVars[2] /* $whenCondition3 DISCRETE */ = (((tmp7 && (data->localData[0]->integerVars[1] /* state DISCRETE */ == 1)) && tmp9) && tmp10);
  TRACE_POP
}
/*
equation index: 23
type: SIMPLE_ASSIGN
$whenCondition4 = Distance + BreakingDistance + 5.0 >= Target and Distance + BreakingDistance - 5.0 <= Target and speed > 0.0 and state == TrainSimulation.TrainLightColor.red
*/
void TrainSimulation_Car_eqFunction_23(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp11, data->localData[0]->realVars[0] /* Distance STATE(1,speed) */ + data->localData[0]->realVars[6] /* BreakingDistance variable */ + 5.0, data->localData[0]->realVars[8] /* Target variable */, 7, GreaterEq);
  RELATIONHYSTERESIS(tmp12, data->localData[0]->realVars[0] /* Distance STATE(1,speed) */ + data->localData[0]->realVars[6] /* BreakingDistance variable */ - 5.0, data->localData[0]->realVars[8] /* Target variable */, 8, LessEq);
  RELATIONHYSTERESIS(tmp13, data->localData[0]->realVars[2] /* speed STATE(1,acceleration) */, 0.0, 2, Greater);
  data->localData[0]->booleanVars[3] /* $whenCondition4 DISCRETE */ = (((tmp11 && tmp12) && tmp13) && (data->localData[0]->integerVars[1] /* state DISCRETE */ == 2));
  TRACE_POP
}
/*
equation index: 28
...
void TrainSimulation_Car_eqFunction_28(DATA *data, threadData_t *threadData)
{
  ...
  {
    data->localData[0]->realVars[1] /* acceleration STATE(1) */ = 0.0;
    infoStreamPrint(LOG_EVENTS, 0, "reinit acceleration = %g", data->localData[0]->realVars[1] /* acceleration STATE(1) */);
...
void TrainSimulation_Car_eqFunction_27(DATA *data, threadData_t *threadData)
{
  ...
  {
    data->localData[0]->realVars[1] /* acceleration STATE(1) */ = (-data->simulationInfo->realParameter[0] /* breakingDeceleration PARAM */);
    infoStreamPrint(LOG_EVENTS, 0, "reinit acceleration = %g", data->localData[0]->realVars[1] /* acceleration STATE(1) */);
    data->simulationInfo->needToIterate = 1;
  }
  TRACE_POP
...
void TrainSimulation_Car_eqFunction_26(DATA *data, threadData_t *threadData)
{
  ...
  {
    data->localData[0]->realVars[1] /* acceleration STATE(1) */ = data->simulationInfo->realParameter[4] /* maxAcceleration PARAM */;
    infoStreamPrint(LOG_EVENTS, 0, "reinit acceleration = %g", data->localData[0]->realVars[1] /* acceleration STATE(1) */);
    data->simulationInfo->needToIterate = 1;
  }
  TRACE_POP
...
void TrainSimulation_Car_eqFunction_24(DATA *data, threadData_t *threadData)
{
  ...
  {
    data->localData[0]->realVars[1] /* acceleration STATE(1) */ = (-data->localData[0]->realVars[2] /* speed STATE(1,acceleration) */);
    infoStreamPrint(LOG_EVENTS, 0, "reinit acceleration = %g", data->localData[0]->realVars[1] /* acceleration STATE(1) */);
    data->simulationInfo->needToIterate = 1;
  }
  TRACE_POP
...
int TrainSimulation_Car_functionDAE(DATA *data, threadData_t *threadData)
{
  ...
  TrainSimulation_Car_eqFunction_15(data, threadData);
...
void TrainSimulation_Car_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{0c5f5863-edc6-4c59-a33c-70c402653102}";
