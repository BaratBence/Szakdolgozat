...
#define MODEL_IDENTIFIER TrainSimulation_VehicleCollection
#define MODEL_GUID "{1d3af18a-3cb4-4418-a57e-a9dcfe5fbea8}"
...
extern void TrainSimulation_VehicleCollection_setupDataStruc(DATA *data, threadData_t *threadData);
#define fmu2_model_interface_setupDataStruc TrainSimulation_VehicleCollection_setupDataStruc
