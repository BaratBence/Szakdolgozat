...
int TrainSimulation_StructureCollection_functionAlgebraics(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  ...
  TrainSimulation_StructureCollection_function_savePreSynchronous(data, threadData);
