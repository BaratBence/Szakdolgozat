...
int TrainCrossing_Sensors_input_function(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[4] /* LengthVec[1] variable */ = data->simulationInfo->inputVars[2];
  data->localData[0]->realVars[5] /* LengthVec[2] variable */ = data->simulationInfo->inputVars[3];
...
int TrainCrossing_Sensors_inputNames(DATA *data, char ** names){
  ...
  names[4] = (char *) data->modelData->booleanVarsData[2].info.name;
...
int TrainCrossing_Sensors_output_function(DATA *data, threadData_t *threadData)
{
  ...
  data->simulationInfo->outputVars[0] = data->localData[0]->realVars[3] /* Intersection variable */;
...
void TrainCrossing_Sensors_eqFunction_9(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp0, data->localData[0]->realVars[1] /* DistanceVec[1] variable */, data->simulationInfo->realParameter[0] /* Sensor1Position PARAM */, 2, GreaterEq);
  RELATIONHYSTERESIS(tmp1, data->localData[0]->realVars[1] /* DistanceVec[1] variable */ - data->localData[0]->realVars[4] /* LengthVec[1] variable */, data->simulationInfo->realParameter[0] /* Sensor1Position PARAM */ + 1.0, 3, LessEq);
...
void TrainCrossing_Sensors_eqFunction_10(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp2, data->localData[0]->realVars[2] /* DistanceVec[2] variable */, data->simulationInfo->realParameter[0] /* Sensor1Position PARAM */, 0, GreaterEq);
  RELATIONHYSTERESIS(tmp3, data->localData[0]->realVars[2] /* DistanceVec[2] variable */ - data->localData[0]->realVars[5] /* LengthVec[2] variable */, data->simulationInfo->realParameter[0] /* Sensor1Position PARAM */ + 1.0, 1, LessEq);
...
equation index: 11
type: SIMPLE_ASSIGN
Sensor1_Active = if not SensorFail then TrainCrossing.Sensors.Active(2, Train_Detected1) else false
*/
void TrainCrossing_Sensors_eqFunction_11(DATA *data, threadData_t *threadData)
{
  ...
  tmp5 = (modelica_boolean)(!data->localData[0]->booleanVars[2] /* SensorFail variable */);
  if(tmp5)
  {
    boolean_array_create(&tmp4, ((modelica_boolean*)&((&data->localData[0]->booleanVars[3] /* Train_Detected1[1] DISCRETE */)[calc_base_index_dims_subs(1, 2, ((modelica_integer) 1))])), 1, 2);
    tmp6 = omc_TrainCrossing_Sensors_Active(threadData, ((modelica_integer) 2), tmp4);
  }
  else
  {
    tmp6 = 0;
  }
  data->localData[0]->booleanVars[0] /* Sensor1_Active variable */ = tmp6;
  TRACE_POP
}
/*
equation index: 12
...
void TrainCrossing_Sensors_eqFunction_12(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp7, data->localData[0]->realVars[1] /* DistanceVec[1] variable */, data->simulationInfo->realParameter[1] /* Sensor2Position PARAM */ + 1.0, 6, GreaterEq);
  RELATIONHYSTERESIS(tmp8, data->localData[0]->realVars[1] /* DistanceVec[1] variable */ - data->localData[0]->realVars[4] /* LengthVec[1] variable */, data->simulationInfo->realParameter[1] /* Sensor2Position PARAM */, 7, LessEq);
  data->localData[0]->booleanVars[5] /* Train_Detected2[1] DISCRETE */ = (tmp7 && tmp8);
  TRACE_POP
}
/*
equation index: 13
...
void TrainCrossing_Sensors_eqFunction_13(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp9, data->localData[0]->realVars[2] /* DistanceVec[2] variable */, data->simulationInfo->realParameter[1] /* Sensor2Position PARAM */ + 1.0, 4, GreaterEq);
  RELATIONHYSTERESIS(tmp10, data->localData[0]->realVars[2] /* DistanceVec[2] variable */ - data->localData[0]->realVars[5] /* LengthVec[2] variable */, data->simulationInfo->realParameter[1] /* Sensor2Position PARAM */, 5, LessEq);
  data->localData[0]->booleanVars[6] /* Train_Detected2[2] DISCRETE */ = (tmp9 && tmp10);
  TRACE_POP
}
/*
equation index: 14
type: SIMPLE_ASSIGN
Sensor2_Active = TrainCrossing.Sensors.Active(2, Train_Detected2)
*/
void TrainCrossing_Sensors_eqFunction_14(DATA *data, threadData_t *threadData)
{
  ...
  boolean_array tmp11;
  boolean_array_create(&tmp11, ((modelica_boolean*)&((&data->localData[0]->booleanVars[5] /* Train_Detected2[1] DISCRETE */)[calc_base_index_dims_subs(1, 2, ((modelica_integer) 1))])), 1, 2);
  data->localData[0]->booleanVars[1] /* Sensor2_Active variable */ = omc_TrainCrossing_Sensors_Active(threadData, ((modelica_integer) 2), tmp11);
  TRACE_POP
}
/*
equation index: 15
...
void TrainCrossing_Sensors_eqFunction_15(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[3] /* Intersection variable */ = data->localData[0]->realVars[0] /* $outputAlias_Intersection variable */;
  TRACE_POP
}
...
void TrainCrossing_Sensors_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{43b7d4db-c1c4-4101-a834-21ffd948b110}";
