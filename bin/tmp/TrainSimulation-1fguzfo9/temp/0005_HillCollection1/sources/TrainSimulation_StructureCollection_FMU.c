...
#define MODEL_IDENTIFIER TrainSimulation_StructureCollection
#define MODEL_GUID "{7ae44e4d-ba63-413d-b3ce-37a832c3c336}"
...
extern void TrainSimulation_StructureCollection_setupDataStruc(DATA *data, threadData_t *threadData);
#define fmu2_model_interface_setupDataStruc TrainSimulation_StructureCollection_setupDataStruc
...
fmi2Real getReal(ModelInstance* comp, const fmi2ValueReference vr) {
  ...
  if (vr < 31) {
    return comp->fmuData->simulationInfo->realParameter[vr-31];
  }
  if (vr < 42) {
    int ix = realAliasIndexes[vr-31];
...
fmi2Status setReal(ModelInstance* comp, const fmi2ValueReference vr, const fmi2Real value) {
  ...
  if (vr < 31) {
    comp->fmuData->simulationInfo->realParameter[vr-31] = value;
    return fmi2OK;
  }
  if (vr < 42) {
    int ix = realAliasIndexes[vr-31];
...
fmi2Boolean getBoolean(ModelInstance* comp, const fmi2ValueReference vr) {
  switch (vr) {
    ...
    case 1 : return getBoolean(comp, 0); break;
    default:
      return fmi2False;
  }
}
...
fmi2Status setBoolean(ModelInstance* comp, const fmi2ValueReference vr, const fmi2Boolean value) {
  switch (vr) {
    ...
    case 1 : return setBoolean(comp, 0, value); break;
    default:
      return fmi2Error;
  }
  return fmi2OK;
