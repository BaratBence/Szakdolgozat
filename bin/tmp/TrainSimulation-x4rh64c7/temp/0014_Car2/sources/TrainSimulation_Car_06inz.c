...
extern void TrainSimulation_Car_eqFunction_15(DATA *data, threadData_t *threadData);
...
extern void TrainSimulation_Car_eqFunction_14(DATA *data, threadData_t *threadData);
...
*/
void TrainSimulation_Car_eqFunction_12(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,12};
  data->localData[0]->realVars[1] /* acceleration STATE(1) */ = data->modelData->realVarsData[1].attribute /* acceleration STATE(1) */.start;
  TRACE_POP
}
...
void TrainSimulation_Car_functionInitialEquations_0(DATA *data, threadData_t *threadData)
{
  ...
  TrainSimulation_Car_eqFunction_12(data, threadData);
