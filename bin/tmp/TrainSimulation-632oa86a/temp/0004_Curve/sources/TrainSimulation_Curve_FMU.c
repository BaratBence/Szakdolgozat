...
#define MODEL_GUID "{1de4e5a2-4a87-4545-976d-0a742ae48c37}"
...
static const int realAliasIndexes[11] = {
  19, 19, 19, 19, 19, 19, 19, 19, 19, 19, 40
};
...
fmi2Real getReal(ModelInstance* comp, const fmi2ValueReference vr) {
  ...
  if (vr < 57) {
    return comp->fmuData->simulationInfo->realParameter[vr-50];
  }
  if (vr < 68) {
    int ix = realAliasIndexes[vr-57];
...
fmi2Status setReal(ModelInstance* comp, const fmi2ValueReference vr, const fmi2Real value) {
  ...
  if (vr < 57) {
    comp->fmuData->simulationInfo->realParameter[vr-50] = value;
    return fmi2OK;
  }
  if (vr < 68) {
    int ix = realAliasIndexes[vr-57];
...
fmi2ValueReference mapOutputReference2OutputNumber(const fmi2ValueReference vr) {
    switch (vr) {
      ...
      case 43: return 13; break;
      case 44: return 14; break;
      case 45: return 15; break;
      case 46: return 16; break;
      case 47: return 17; break;
      case 48: return 18; break;
      case 49: return 19; break;
      default:
        return -1;
    }
}
