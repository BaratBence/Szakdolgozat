...
void TrainSimulation_Train_eqFunction_36(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp6, data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, data->simulationInfo->realParameter[5] /* maxSpeed PARAM */, 11, Less);
...
equation index: 41
type: SIMPLE_ASSIGN
$whenCondition11 = inStation and speed <= 0.0 and lapDistance + BreakingDistance + 5.0 >= Sensor1Position - 10.0 and lapDistance + BreakingDistance - 5.0 <= Sensor1Position - 10.0 and state == TrainSimulation.StationSignal.green
*/
void TrainSimulation_Train_eqFunction_41(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp19, data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, 0.0, 12, LessEq);
  RELATIONHYSTERESIS(tmp20, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */ + data->localData[0]->realVars[8] /* BreakingDistance variable */ + 5.0, data->localData[0]->realVars[11] /* Sensor1Position variable */ - 10.0, 16, GreaterEq);
  RELATIONHYSTERESIS(tmp21, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */ + data->localData[0]->realVars[8] /* BreakingDistance variable */ - 5.0, data->localData[0]->realVars[11] /* Sensor1Position variable */ - 10.0, 17, LessEq);
  data->localData[0]->booleanVars[2] /* $whenCondition11 DISCRETE */ = ((((data->localData[0]->booleanVars[17] /* inStation DISCRETE */ && tmp19) && tmp20) && tmp21) && (data->localData[0]->integerVars[2] /* state DISCRETE */ == 1));
  TRACE_POP
}
/*
equation index: 42
...
void TrainSimulation_Train_eqFunction_48(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp23, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */, data->simulationInfo->realParameter[3] /* lap PARAM */, 5, GreaterEq);
...
void TrainSimulation_Train_eqFunction_49(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp24, data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, data->localData[0]->realVars[14] /* onCurveSpeed variable */, 4, GreaterEq);
...
void TrainSimulation_Train_eqFunction_50(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp25, data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, data->localData[0]->realVars[14] /* onCurveSpeed variable */, 3, LessEq);
...
void TrainSimulation_Train_eqFunction_51(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp26, data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, data->simulationInfo->realParameter[5] /* maxSpeed PARAM */, 2, GreaterEq);
  data->localData[0]->booleanVars[8] /* $whenCondition5 DISCRETE */ = tmp26;
  TRACE_POP
}
/*
equation index: 52
...
void TrainSimulation_Train_eqFunction_52(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp27, data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, (data->simulationInfo->realParameter[5] /* maxSpeed PARAM */) * (data->localData[0]->realVars[15] /* onUpHillSpeedScale variable */), 1, GreaterEq);
  data->localData[0]->booleanVars[9] /* $whenCondition6 DISCRETE */ = (tmp27 && data->localData[0]->booleanVars[14] /* ActiveUpHill variable */);
  TRACE_POP
}
/*
equation index: 53
...
void TrainSimulation_Train_eqFunction_53(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp28, data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, (data->simulationInfo->realParameter[5] /* maxSpeed PARAM */) * (data->localData[0]->realVars[15] /* onUpHillSpeedScale variable */), 0, LessEq);
  data->localData[0]->booleanVars[10] /* $whenCondition7 DISCRETE */ = (tmp28 && data->localData[0]->booleanVars[14] /* ActiveUpHill variable */);
  TRACE_POP
}
/*
equation index: 54
...
void TrainSimulation_Train_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{e7d50cb8-9484-4879-beac-1fd4ffbf577a}";
