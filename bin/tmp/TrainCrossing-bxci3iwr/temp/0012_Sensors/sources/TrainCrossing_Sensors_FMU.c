...
#define MODEL_GUID "{43b7d4db-c1c4-4101-a834-21ffd948b110}"
...
void setDefaultStartValues(ModelInstance *comp) {
  ...
  comp->fmuData->modelData->realVarsData[3].attribute.start = 300.0;
...
fmi2Real getReal(ModelInstance* comp, const fmi2ValueReference vr) {
  ...
  if (vr < 8) {
    return comp->fmuData->simulationInfo->realParameter[vr-6];
  }
  return NAN;
}
...
fmi2Status setReal(ModelInstance* comp, const fmi2ValueReference vr, const fmi2Real value) {
  ...
  if (vr < 8) {
    comp->fmuData->simulationInfo->realParameter[vr-6] = value;
    return fmi2OK;
  }
  return fmi2Error;
}
...
fmi2Boolean getBoolean(ModelInstance* comp, const fmi2ValueReference vr) {
  switch (vr) {
    ...
    case 7 : return getBoolean(comp, 0); break;
    case 8 : return getBoolean(comp, 1); break;
    default:
      return fmi2False;
  }
}
...
fmi2Status setBoolean(ModelInstance* comp, const fmi2ValueReference vr, const fmi2Boolean value) {
  switch (vr) {
    ...
    case 7 : return setBoolean(comp, 0, value); break;
    case 8 : return setBoolean(comp, 1, value); break;
    default:
      return fmi2Error;
  }
  return fmi2OK;
