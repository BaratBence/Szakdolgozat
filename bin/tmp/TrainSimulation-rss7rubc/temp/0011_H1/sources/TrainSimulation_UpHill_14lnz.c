...
const char *TrainSimulation_UpHill_linear_model_frame()
{
  ...
  "  Real 'y_HillSpeedScale[1]' = y[1];\n""  Real 'y_HillSpeedScale[2]' = y[2];\n""  Real 'y_HillSpeedScale[3]' = y[3];\n""  Real 'y_HillSpeedScale[4]' = y[4];\n""  Real 'y_HillSpeedScale[5]' = y[5];\n""  Real 'y_HillSpeedScale[6]' = y[6];\n""  Real 'y_HillSpeedScale[7]' = y[7];\n""  Real 'y_HillSpeedScale[8]' = y[8];\n""  Real 'y_HillSpeedScale[9]' = y[9];\n""  Real 'y_HillSpeedScale[10]' = y[10];\n""  Real 'y_onHill[1]' = y[11];\n""  Real 'y_onHill[2]' = y[12];\n""  Real 'y_onHill[3]' = y[13];\n""  Real 'y_onHill[4]' = y[14];\n""  Real 'y_onHill[5]' = y[15];\n""  Real 'y_onHill[6]' = y[16];\n""  Real 'y_onHill[7]' = y[17];\n""  Real 'y_onHill[8]' = y[18];\n""  Real 'y_onHill[9]' = y[19];\n""  Real 'y_onHill[10]' = y[20];\n"
