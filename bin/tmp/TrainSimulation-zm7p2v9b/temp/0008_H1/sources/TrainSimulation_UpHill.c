...
int TrainSimulation_UpHill_input_function(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[2] /* TrainDistance[1] variable */ = data->simulationInfo->inputVars[0];
  data->localData[0]->realVars[3] /* TrainDistance[2] variable */ = data->simulationInfo->inputVars[1];
  data->localData[0]->realVars[4] /* TrainDistance[3] variable */ = data->simulationInfo->inputVars[2];
  data->localData[0]->realVars[5] /* TrainDistance[4] variable */ = data->simulationInfo->inputVars[3];
  data->localData[0]->realVars[6] /* TrainDistance[5] variable */ = data->simulationInfo->inputVars[4];
  data->localData[0]->realVars[7] /* TrainDistance[6] variable */ = data->simulationInfo->inputVars[5];
  data->localData[0]->realVars[8] /* TrainDistance[7] variable */ = data->simulationInfo->inputVars[6];
  data->localData[0]->realVars[9] /* TrainDistance[8] variable */ = data->simulationInfo->inputVars[7];
  data->localData[0]->realVars[10] /* TrainDistance[9] variable */ = data->simulationInfo->inputVars[8];
  data->localData[0]->realVars[11] /* TrainDistance[10] variable */ = data->simulationInfo->inputVars[9];
  data->localData[0]->realVars[12] /* TrainLength[1] variable */ = data->simulationInfo->inputVars[10];
  data->localData[0]->realVars[13] /* TrainLength[2] variable */ = data->simulationInfo->inputVars[11];
  data->localData[0]->realVars[14] /* TrainLength[3] variable */ = data->simulationInfo->inputVars[12];
  data->localData[0]->realVars[15] /* TrainLength[4] variable */ = data->simulationInfo->inputVars[13];
  data->localData[0]->realVars[16] /* TrainLength[5] variable */ = data->simulationInfo->inputVars[14];
  data->localData[0]->realVars[17] /* TrainLength[6] variable */ = data->simulationInfo->inputVars[15];
  data->localData[0]->realVars[18] /* TrainLength[7] variable */ = data->simulationInfo->inputVars[16];
  data->localData[0]->realVars[19] /* TrainLength[8] variable */ = data->simulationInfo->inputVars[17];
  data->localData[0]->realVars[20] /* TrainLength[9] variable */ = data->simulationInfo->inputVars[18];
  data->localData[0]->realVars[21] /* TrainLength[10] variable */ = data->simulationInfo->inputVars[19];
...
int TrainSimulation_UpHill_input_function_init(DATA *data, threadData_t *threadData)
{
  ...
  data->simulationInfo->inputVars[1] = data->modelData->realVarsData[3].attribute.start;
  ...
  data->simulationInfo->inputVars[6] = data->modelData->realVarsData[8].attribute.start;
  data->simulationInfo->inputVars[7] = data->modelData->realVarsData[9].attribute.start;
  data->simulationInfo->inputVars[8] = data->modelData->realVarsData[10].attribute.start;
  data->simulationInfo->inputVars[9] = data->modelData->realVarsData[11].attribute.start;
...
int TrainSimulation_UpHill_input_function_updateStartValues(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->realVarsData[3].attribute.start = data->simulationInfo->inputVars[1];
  ...
  data->modelData->realVarsData[8].attribute.start = data->simulationInfo->inputVars[6];
  data->modelData->realVarsData[9].attribute.start = data->simulationInfo->inputVars[7];
  data->modelData->realVarsData[10].attribute.start = data->simulationInfo->inputVars[8];
  data->modelData->realVarsData[11].attribute.start = data->simulationInfo->inputVars[9];
...
int TrainSimulation_UpHill_inputNames(DATA *data, char ** names){
  ...
  names[1] = (char *) data->modelData->realVarsData[3].info.name;
  ...
  names[6] = (char *) data->modelData->realVarsData[8].info.name;
  names[7] = (char *) data->modelData->realVarsData[9].info.name;
  names[8] = (char *) data->modelData->realVarsData[10].info.name;
  names[9] = (char *) data->modelData->realVarsData[11].info.name;
...
int TrainSimulation_UpHill_output_function(DATA *data, threadData_t *threadData)
{
  ...
  data->simulationInfo->outputVars[0] = data->localData[0]->realVars[1] /* HillSpeedScale variable */;
  data->simulationInfo->outputVars[1] = data->localData[0]->realVars[22] /* onHill[1] variable */;
  data->simulationInfo->outputVars[2] = data->localData[0]->realVars[23] /* onHill[2] variable */;
  data->simulationInfo->outputVars[3] = data->localData[0]->realVars[24] /* onHill[3] variable */;
  data->simulationInfo->outputVars[4] = data->localData[0]->realVars[25] /* onHill[4] variable */;
  data->simulationInfo->outputVars[5] = data->localData[0]->realVars[26] /* onHill[5] variable */;
  data->simulationInfo->outputVars[6] = data->localData[0]->realVars[27] /* onHill[6] variable */;
  data->simulationInfo->outputVars[7] = data->localData[0]->realVars[28] /* onHill[7] variable */;
  data->simulationInfo->outputVars[8] = data->localData[0]->realVars[29] /* onHill[8] variable */;
  data->simulationInfo->outputVars[9] = data->localData[0]->realVars[30] /* onHill[9] variable */;
  data->simulationInfo->outputVars[10] = data->localData[0]->realVars[31] /* onHill[10] variable */;
...
equation index: 13
type: SIMPLE_ASSIGN
HillSpeedScale = $outputAlias_HillSpeedScale
*/
void TrainSimulation_UpHill_eqFunction_13(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,13};
  data->localData[0]->realVars[1] /* HillSpeedScale variable */ = data->localData[0]->realVars[0] /* $outputAlias_HillSpeedScale variable */;
  TRACE_POP
}
/*
equation index: 14
...
void TrainSimulation_UpHill_eqFunction_14(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp0, data->localData[0]->realVars[2] /* TrainDistance[1] variable */, data->simulationInfo->realParameter[1] /* Start PARAM */, 0, GreaterEq);
  RELATIONHYSTERESIS(tmp1, data->localData[0]->realVars[2] /* TrainDistance[1] variable */, data->simulationInfo->realParameter[0] /* End PARAM */ + data->localData[0]->realVars[12] /* TrainLength[1] variable */, 1, LessEq);
  data->localData[0]->realVars[22] /* onHill[1] variable */ = ((tmp0 && tmp1)?1.0:0.0);
  TRACE_POP
}
/*
equation index: 15
...
void TrainSimulation_UpHill_eqFunction_15(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp2, data->localData[0]->realVars[3] /* TrainDistance[2] variable */, data->simulationInfo->realParameter[1] /* Start PARAM */, 2, GreaterEq);
  RELATIONHYSTERESIS(tmp3, data->localData[0]->realVars[3] /* TrainDistance[2] variable */, data->simulationInfo->realParameter[0] /* End PARAM */ + data->localData[0]->realVars[13] /* TrainLength[2] variable */, 3, LessEq);
  data->localData[0]->realVars[23] /* onHill[2] variable */ = ((tmp2 && tmp3)?1.0:0.0);
  TRACE_POP
}
/*
equation index: 16
...
void TrainSimulation_UpHill_eqFunction_16(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp4, data->localData[0]->realVars[4] /* TrainDistance[3] variable */, data->simulationInfo->realParameter[1] /* Start PARAM */, 4, GreaterEq);
  RELATIONHYSTERESIS(tmp5, data->localData[0]->realVars[4] /* TrainDistance[3] variable */, data->simulationInfo->realParameter[0] /* End PARAM */ + data->localData[0]->realVars[14] /* TrainLength[3] variable */, 5, LessEq);
  data->localData[0]->realVars[24] /* onHill[3] variable */ = ((tmp4 && tmp5)?1.0:0.0);
  TRACE_POP
}
/*
equation index: 17
...
void TrainSimulation_UpHill_eqFunction_17(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp6, data->localData[0]->realVars[5] /* TrainDistance[4] variable */, data->simulationInfo->realParameter[1] /* Start PARAM */, 6, GreaterEq);
  RELATIONHYSTERESIS(tmp7, data->localData[0]->realVars[5] /* TrainDistance[4] variable */, data->simulationInfo->realParameter[0] /* End PARAM */ + data->localData[0]->realVars[15] /* TrainLength[4] variable */, 7, LessEq);
  data->localData[0]->realVars[25] /* onHill[4] variable */ = ((tmp6 && tmp7)?1.0:0.0);
  TRACE_POP
}
/*
equation index: 18
...
void TrainSimulation_UpHill_eqFunction_18(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp8, data->localData[0]->realVars[6] /* TrainDistance[5] variable */, data->simulationInfo->realParameter[1] /* Start PARAM */, 8, GreaterEq);
  RELATIONHYSTERESIS(tmp9, data->localData[0]->realVars[6] /* TrainDistance[5] variable */, data->simulationInfo->realParameter[0] /* End PARAM */ + data->localData[0]->realVars[16] /* TrainLength[5] variable */, 9, LessEq);
  data->localData[0]->realVars[26] /* onHill[5] variable */ = ((tmp8 && tmp9)?1.0:0.0);
  TRACE_POP
}
/*
equation index: 19
...
void TrainSimulation_UpHill_eqFunction_19(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp10, data->localData[0]->realVars[7] /* TrainDistance[6] variable */, data->simulationInfo->realParameter[1] /* Start PARAM */, 10, GreaterEq);
  RELATIONHYSTERESIS(tmp11, data->localData[0]->realVars[7] /* TrainDistance[6] variable */, data->simulationInfo->realParameter[0] /* End PARAM */ + data->localData[0]->realVars[17] /* TrainLength[6] variable */, 11, LessEq);
  data->localData[0]->realVars[27] /* onHill[6] variable */ = ((tmp10 && tmp11)?1.0:0.0);
  TRACE_POP
}
/*
equation index: 20
...
void TrainSimulation_UpHill_eqFunction_20(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp12, data->localData[0]->realVars[8] /* TrainDistance[7] variable */, data->simulationInfo->realParameter[1] /* Start PARAM */, 12, GreaterEq);
  RELATIONHYSTERESIS(tmp13, data->localData[0]->realVars[8] /* TrainDistance[7] variable */, data->simulationInfo->realParameter[0] /* End PARAM */ + data->localData[0]->realVars[18] /* TrainLength[7] variable */, 13, LessEq);
  data->localData[0]->realVars[28] /* onHill[7] variable */ = ((tmp12 && tmp13)?1.0:0.0);
  TRACE_POP
}
/*
equation index: 21
...
void TrainSimulation_UpHill_eqFunction_21(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp14, data->localData[0]->realVars[9] /* TrainDistance[8] variable */, data->simulationInfo->realParameter[1] /* Start PARAM */, 14, GreaterEq);
  RELATIONHYSTERESIS(tmp15, data->localData[0]->realVars[9] /* TrainDistance[8] variable */, data->simulationInfo->realParameter[0] /* End PARAM */ + data->localData[0]->realVars[19] /* TrainLength[8] variable */, 15, LessEq);
  data->localData[0]->realVars[29] /* onHill[8] variable */ = ((tmp14 && tmp15)?1.0:0.0);
  TRACE_POP
}
/*
equation index: 22
...
void TrainSimulation_UpHill_eqFunction_22(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp16, data->localData[0]->realVars[10] /* TrainDistance[9] variable */, data->simulationInfo->realParameter[1] /* Start PARAM */, 16, GreaterEq);
  RELATIONHYSTERESIS(tmp17, data->localData[0]->realVars[10] /* TrainDistance[9] variable */, data->simulationInfo->realParameter[0] /* End PARAM */ + data->localData[0]->realVars[20] /* TrainLength[9] variable */, 17, LessEq);
  data->localData[0]->realVars[30] /* onHill[9] variable */ = ((tmp16 && tmp17)?1.0:0.0);
  TRACE_POP
}
/*
equation index: 23
...
*/
void TrainSimulation_UpHill_eqFunction_23(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,23};
  modelica_boolean tmp18;
  modelica_boolean tmp19;
  RELATIONHYSTERESIS(tmp18, data->localData[0]->realVars[11] /* TrainDistance[10] variable */, data->simulationInfo->realParameter[1] /* Start PARAM */, 18, GreaterEq);
  RELATIONHYSTERESIS(tmp19, data->localData[0]->realVars[11] /* TrainDistance[10] variable */, data->simulationInfo->realParameter[0] /* End PARAM */ + data->localData[0]->realVars[21] /* TrainLength[10] variable */, 19, LessEq);
  data->localData[0]->realVars[31] /* onHill[10] variable */ = ((tmp18 && tmp19)?1.0:0.0);
  TRACE_POP
}
...
void TrainSimulation_UpHill_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{4e928f74-50f8-4ef8-acec-504768828ea7}";
