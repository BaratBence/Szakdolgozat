...
void TrainSimulation_Train_eqFunction_33(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp0, data->localData[0]->realVars[0] /* acceleration STATE(1) */, 0.0, 3, Less);
  data->localData[0]->booleanVars[17] /* Decelerating DISCRETE */ = tmp0;
  TRACE_POP
}
/*
equation index: 34
...
void TrainSimulation_Train_eqFunction_40(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp2, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */ + data->localData[0]->realVars[8] /* BreakingDistance variable */ + 10.0, data->localData[0]->realVars[11] /* Sensor1Position variable */, 4, GreaterEq);
  RELATIONHYSTERESIS(tmp3, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */, data->localData[0]->realVars[12] /* Sensor2Position variable */, 5, LessEq);
  data->localData[0]->booleanVars[18] /* inStation DISCRETE */ = (tmp2 && tmp3);
  TRACE_POP
}
/*
equation index: 41
...
void TrainSimulation_Train_eqFunction_41(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp4, data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, data->simulationInfo->realParameter[5] /* maxSpeed PARAM */, 6, GreaterEq);
  data->localData[0]->booleanVars[9] /* $whenCondition5 DISCRETE */ = ((((tmp4 && (!data->localData[0]->booleanVars[14] /* ActiveCurve variable */)) && (!data->localData[0]->booleanVars[15] /* ActiveUpHill variable */)) && (!data->localData[0]->booleanVars[17] /* Decelerating DISCRETE */)) && (!data->localData[0]->booleanVars[18] /* inStation DISCRETE */));
  TRACE_POP
}
/*
equation index: 42
...
void TrainSimulation_Train_eqFunction_42(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp5, data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, data->simulationInfo->realParameter[5] /* maxSpeed PARAM */, 7, LessEq);
  data->localData[0]->booleanVars[10] /* $whenCondition6 DISCRETE */ = ((((data->localData[0]->booleanVars[17] /* Decelerating DISCRETE */ && tmp5) && (!data->localData[0]->booleanVars[14] /* ActiveCurve variable */)) && (!data->localData[0]->booleanVars[15] /* ActiveUpHill variable */)) && (!data->localData[0]->booleanVars[18] /* inStation DISCRETE */));
  TRACE_POP
}
/*
equation index: 43
...
void TrainSimulation_Train_eqFunction_43(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp6, data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, 0.0, 14, LessEq);
  data->localData[0]->booleanVars[3] /* $whenCondition12 DISCRETE */ = (data->localData[0]->booleanVars[18] /* inStation DISCRETE */ && tmp6);
  TRACE_POP
}
/*
equation index: 44
...
void TrainSimulation_Train_eqFunction_44(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp7, data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, data->simulationInfo->realParameter[5] /* maxSpeed PARAM */, 6, GreaterEq);
  data->localData[0]->booleanVars[4] /* $whenCondition13 DISCRETE */ = (data->localData[0]->booleanVars[18] /* inStation DISCRETE */ && tmp7);
  TRACE_POP
}
/*
equation index: 45
...
void TrainSimulation_Train_eqFunction_46(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp8, data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, 0.0, 8, Greater);
  RELATIONHYSTERESIS(tmp9, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */ + data->localData[0]->realVars[8] /* BreakingDistance variable */ + 5.0, data->localData[0]->realVars[11] /* Sensor1Position variable */, 9, GreaterEq);
  RELATIONHYSTERESIS(tmp10, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */ + data->localData[0]->realVars[8] /* BreakingDistance variable */ - 5.0, data->localData[0]->realVars[11] /* Sensor1Position variable */, 10, LessEq);
...
void TrainSimulation_Train_eqFunction_47(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp12, data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, data->simulationInfo->realParameter[5] /* maxSpeed PARAM */, 11, Less);
  RELATIONHYSTERESIS(tmp13, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */ + data->localData[0]->realVars[8] /* BreakingDistance variable */ + 5.0, data->localData[0]->realVars[11] /* Sensor1Position variable */, 9, GreaterEq);
  RELATIONHYSTERESIS(tmp14, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */ + data->localData[0]->realVars[8] /* BreakingDistance variable */ - 5.0, data->localData[0]->realVars[11] /* Sensor1Position variable */, 10, LessEq);
...
void TrainSimulation_Train_eqFunction_48(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp16, data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, 0.0, 8, Greater);
  RELATIONHYSTERESIS(tmp17, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */ + data->localData[0]->realVars[8] /* BreakingDistance variable */ + 5.0, data->localData[0]->realVars[13] /* Station variable */, 12, GreaterEq);
  RELATIONHYSTERESIS(tmp18, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */ + data->localData[0]->realVars[8] /* BreakingDistance variable */ - 5.0, data->localData[0]->realVars[13] /* Station variable */, 13, LessEq);
...
void TrainSimulation_Train_eqFunction_49(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp21, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */ + data->localData[0]->realVars[8] /* BreakingDistance variable */ + 5.0, data->localData[0]->realVars[13] /* Station variable */, 12, GreaterEq);
...
void TrainSimulation_Train_eqFunction_50(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp22, data->localData[0]->realVars[3] /* speed STATE(1,acceleration) */, 0.0, 14, LessEq);
  RELATIONHYSTERESIS(tmp23, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */ + 10.0, data->localData[0]->realVars[13] /* Station variable */, 15, GreaterEq);
  data->localData[0]->booleanVars[16] /* Arrived variable */ = (((data->localData[0]->booleanVars[18] /* inStation DISCRETE */ && tmp22) && tmp23) && (!(data->localData[0]->integerVars[2] /* state DISCRETE */ == 4)));
  TRACE_POP
}
/*
equation index: 51
...
void TrainSimulation_Train_eqFunction_52(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp25, data->localData[0]->realVars[2] /* lapDistance STATE(1,speed) */, data->simulationInfo->realParameter[3] /* lap PARAM */, 2, GreaterEq);
...
void TrainSimulation_Train_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{c1ba5ed3-09e1-4b85-a2e5-4e37201fc420}";
