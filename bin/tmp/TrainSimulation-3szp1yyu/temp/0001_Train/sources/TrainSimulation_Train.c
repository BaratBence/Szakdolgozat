...
equation index: 51
type: SIMPLE_ASSIGN
$whenCondition4 = speed <= maxSpeed and not ActiveCurve and not ActiveUpHill
*/
void TrainSimulation_Train_eqFunction_51(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->booleanVars[7] /* $whenCondition4 DISCRETE */ = ((tmp26 && (!data->localData[0]->booleanVars[13] /* ActiveCurve variable */)) && (!data->localData[0]->booleanVars[14] /* ActiveUpHill variable */));
  TRACE_POP
}
/*
equation index: 52
...
void TrainSimulation_Train_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{20e2d042-f45c-4694-bd70-5ef266a4380f}";
