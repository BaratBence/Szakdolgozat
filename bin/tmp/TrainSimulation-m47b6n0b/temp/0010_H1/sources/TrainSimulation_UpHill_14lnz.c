...
const char *TrainSimulation_UpHill_linear_model_frame()
{
  ...
  "  Real 'y_HillSpeedScale' = y[1];\n""  Real 'y_onHill[1]' = y[2];\n""  Real 'y_onHill[2]' = y[3];\n""  Real 'y_onHill[3]' = y[4];\n""  Real 'y_onHill[4]' = y[5];\n""  Real 'y_onHill[5]' = y[6];\n""  Real 'y_onHill[6]' = y[7];\n""  Real 'y_onHill[7]' = y[8];\n""  Real 'y_onHill[8]' = y[9];\n""  Real 'y_onHill[9]' = y[10];\n""  Real 'y_onHill[10]' = y[11];\n"
