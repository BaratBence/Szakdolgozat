...
#define MODEL_IDENTIFIER TrainSimulation_UpHill
#define MODEL_GUID "{4e928f74-50f8-4ef8-acec-504768828ea7}"
...
extern void TrainSimulation_UpHill_setupDataStruc(DATA *data, threadData_t *threadData);
#define fmu2_model_interface_setupDataStruc TrainSimulation_UpHill_setupDataStruc
...
void setDefaultStartValues(ModelInstance *comp) {
  ...
  comp->fmuData->modelData->realParameterData[2].attribute.start = 30.0;
