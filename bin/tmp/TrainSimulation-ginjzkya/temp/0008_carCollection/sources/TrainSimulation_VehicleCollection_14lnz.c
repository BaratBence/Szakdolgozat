...
const char *TrainSimulation_VehicleCollection_linear_model_frame()
{
  ...
  "equation\n  der(x) = A * x + B * u;\n  y = C * x + D * u;\nend linear_TrainSimulation_VehicleCollection;\n";
}
const char *TrainSimulation_VehicleCollection_linear_model_datarecovery_frame()
{
