...
#define MODEL_GUID "{18559699-49b0-491e-9aeb-b30172896581}"
...
fmi2Boolean getBoolean(ModelInstance* comp, const fmi2ValueReference vr) {
  switch (vr) {
    ...
    case 8 : return comp->fmuData->simulationInfo->booleanParameter[0]; break;
    case 9 : return getBoolean(comp, 0); break;
    case 10 : return getBoolean(comp, 1); break;
    default:
      return fmi2False;
  }
}
...
fmi2Status setBoolean(ModelInstance* comp, const fmi2ValueReference vr, const fmi2Boolean value) {
  switch (vr) {
    ...
    case 8 : comp->fmuData->simulationInfo->booleanParameter[0] = value; break;
    case 9 : return setBoolean(comp, 0, value); break;
    case 10 : return setBoolean(comp, 1, value); break;
    default:
      return fmi2Error;
  }
  return fmi2OK;
