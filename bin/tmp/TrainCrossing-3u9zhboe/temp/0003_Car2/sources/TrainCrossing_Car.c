...
int TrainCrossing_Car_input_function(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[8] /* DistanceVec[1] variable */ = data->simulationInfo->inputVars[0];
  data->localData[0]->realVars[9] /* DistanceVec[2] variable */ = data->simulationInfo->inputVars[1];
  data->localData[0]->realVars[10] /* DistanceVec[3] variable */ = data->simulationInfo->inputVars[2];
  data->localData[0]->realVars[11] /* Gate_Angle variable */ = data->simulationInfo->inputVars[3];
  data->localData[0]->realVars[12] /* LengthVec[1] variable */ = data->simulationInfo->inputVars[4];
  data->localData[0]->realVars[13] /* LengthVec[2] variable */ = data->simulationInfo->inputVars[5];
  data->localData[0]->realVars[14] /* LengthVec[3] variable */ = data->simulationInfo->inputVars[6];
  data->localData[0]->realVars[15] /* Target variable */ = data->simulationInfo->inputVars[7];
...
int TrainCrossing_Car_input_function_init(DATA *data, threadData_t *threadData)
{
  ...
  data->simulationInfo->inputVars[2] = data->modelData->realVarsData[10].attribute.start;
  data->simulationInfo->inputVars[3] = data->modelData->realVarsData[11].attribute.start;
  data->simulationInfo->inputVars[4] = data->modelData->realVarsData[12].attribute.start;
  data->simulationInfo->inputVars[5] = data->modelData->realVarsData[13].attribute.start;
  data->simulationInfo->inputVars[6] = data->modelData->realVarsData[14].attribute.start;
  data->simulationInfo->inputVars[7] = data->modelData->realVarsData[15].attribute.start;
...
int TrainCrossing_Car_input_function_updateStartValues(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->realVarsData[10].attribute.start = data->simulationInfo->inputVars[2];
  data->modelData->realVarsData[11].attribute.start = data->simulationInfo->inputVars[3];
  data->modelData->realVarsData[12].attribute.start = data->simulationInfo->inputVars[4];
  data->modelData->realVarsData[13].attribute.start = data->simulationInfo->inputVars[5];
  data->modelData->realVarsData[14].attribute.start = data->simulationInfo->inputVars[6];
  data->modelData->realVarsData[15].attribute.start = data->simulationInfo->inputVars[7];
...
int TrainCrossing_Car_inputNames(DATA *data, char ** names){
  ...
  names[3] = (char *) data->modelData->realVarsData[11].info.name;
  names[4] = (char *) data->modelData->realVarsData[12].info.name;
  names[5] = (char *) data->modelData->realVarsData[13].info.name;
  names[6] = (char *) data->modelData->realVarsData[14].info.name;
  names[7] = (char *) data->modelData->integerVarsData[0].info.name;
  names[8] = (char *) data->modelData->realVarsData[15].info.name;
...
*/
void TrainCrossing_Car_eqFunction_13(DATA *data, threadData_t *threadData)
{
  TRACE_PUSH
  const int equationIndexes[2] = {1,13};
  real_array tmp0;
  real_array tmp1;
  real_array_create(&tmp0, ((modelica_real*)&((&data->localData[0]->realVars[8] /* DistanceVec[1] variable */)[calc_base_index_dims_subs(1, 3, ((modelica_integer) 1))])), 1, 3);
  real_array_create(&tmp1, ((modelica_real*)&((&data->localData[0]->realVars[12] /* LengthVec[1] variable */)[calc_base_index_dims_subs(1, 3, ((modelica_integer) 1))])), 1, 3);
  data->localData[0]->realVars[6] /* $cse1 variable */ = omc_TrainCrossing_Car_BreakCheck(threadData, ((modelica_integer) 3), data->localData[0]->realVars[1] /* distance STATE(1,speed) */, data->localData[0]->realVars[15] /* Target variable */, tmp0, tmp1);
  TRACE_POP
}
/*
equation index: 14
type: SIMPLE_ASSIGN
$whenCondition4 = speed >= maxSpeed
*/
void TrainCrossing_Car_eqFunction_14(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp2, data->localData[0]->realVars[2] /* speed STATE(1,acceleration) */, data->simulationInfo->realParameter[4] /* maxSpeed PARAM */, 7, GreaterEq);
  data->localData[0]->booleanVars[3] /* $whenCondition4 DISCRETE */ = tmp2;
  TRACE_POP
}
/*
equation index: 15
type: SIMPLE_ASSIGN
$whenCondition1 = speed <= 0.0
*/
void TrainCrossing_Car_eqFunction_15(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp3, data->localData[0]->realVars[2] /* speed STATE(1,acceleration) */, 0.0, 0, LessEq);
...
void TrainCrossing_Car_eqFunction_16(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[7] /* BreakingDistance variable */ = (0.5) * (((tmp4 * tmp4)) * (data->simulationInfo->realParameter[1] /* breakingDeceleration PARAM */)) + data->localData[0]->realVars[6] /* $cse1 variable */;
  TRACE_POP
}
/*
equation index: 17
...
equation index: 21
type: SIMPLE_ASSIGN
$whenCondition2 = distance < Target and state == TrainCrossing.TrainLightColor.on and Gate_Angle >= 90.0 and speed < maxSpeed
*/
void TrainCrossing_Car_eqFunction_21(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp5, data->localData[0]->realVars[1] /* distance STATE(1,speed) */, data->localData[0]->realVars[15] /* Target variable */, 1, Less);
  RELATIONHYSTERESIS(tmp7, data->localData[0]->realVars[11] /* Gate_Angle variable */, 90.0, 2, GreaterEq);
  RELATIONHYSTERESIS(tmp8, data->localData[0]->realVars[2] /* speed STATE(1,acceleration) */, data->simulationInfo->realParameter[4] /* maxSpeed PARAM */, 3, Less);
  data->localData[0]->booleanVars[1] /* $whenCondition2 DISCRETE */ = (((tmp5 && (data->localData[0]->integerVars[1] /* state DISCRETE */ == 1)) && tmp7) && tmp8);
  TRACE_POP
}
/*
equation index: 22
type: SIMPLE_ASSIGN
$whenCondition3 = distance + BreakingDistance + 5.0 >= Target and distance + BreakingDistance - 5.0 <= Target and speed > 0.0 and state == TrainCrossing.TrainLightColor.red
*/
void TrainCrossing_Car_eqFunction_22(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp9, data->localData[0]->realVars[1] /* distance STATE(1,speed) */ + data->localData[0]->realVars[7] /* BreakingDistance variable */ + 5.0, data->localData[0]->realVars[15] /* Target variable */, 4, GreaterEq);
  RELATIONHYSTERESIS(tmp10, data->localData[0]->realVars[1] /* distance STATE(1,speed) */ + data->localData[0]->realVars[7] /* BreakingDistance variable */ - 5.0, data->localData[0]->realVars[15] /* Target variable */, 5, LessEq);
  RELATIONHYSTERESIS(tmp11, data->localData[0]->realVars[2] /* speed STATE(1,acceleration) */, 0.0, 6, Greater);
  data->localData[0]->booleanVars[2] /* $whenCondition3 DISCRETE */ = (((tmp9 && tmp10) && tmp11) && (data->localData[0]->integerVars[1] /* state DISCRETE */ == 2));
  TRACE_POP
}
/*
equation index: 26
...
void TrainCrossing_Car_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->modelGUID = "{4a8755ec-cfb7-44d0-8efd-1945b522b8c2}";
